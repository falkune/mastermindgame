...
class GridGameRow{
    ...
    constructor(ParentElt, nbCage, COMBINATION){
        ...
        this.drawCheckbox(RIGHTSIDE, nbCage);
    ...
    drawCheckbox(ParentElt, nbCage){


        for(let i = 0; i < nbCage; i++){

            new checkPosition(ParentElt);
